...
export default async function getMinAmountSell(betAmount,marketId,outcomeIndex) {
    ...
    const minSharesToBuy=await marketContract.calcSellAmount(marketId,etherAmount,outcomeIndex);
